...
const Header = () => {
  return (
    <header className="fixed md:hidden bg-white top-0 flex items-center justify-between dark:bg-neutral-950 w-full z-50 border-b border-r-zinc-300 dark:border-neutral-700 px-3 py-2 sm:-ml-6">
      <Link href="/dashboard">
        <p className="font-semibold text-xl">Gather Pets</p>
      </Link>
